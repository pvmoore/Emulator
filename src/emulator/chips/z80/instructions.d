...
Instruction[16][16] primary = [
    ...
    [
        ...
        Instruction(0x01, "ld bc, %04x",    10, _ldddnn),
        ...
        Instruction(0x06, "ld b, %02x",     2,  _ldrn),
        ...
        Instruction(0x0e, "ld c, %02x",     2,  _ldrn),
        Instruction(0x0f, "rrca",           4,  _rrca),
    ],
    // row 1
    [
        Instruction(0x10, "djnz %02x",      8,  _djnze),
        Instruction(0x11, "ld de, %04x",    10, _ldddnn),
        Instruction(0x12, "ld (de), a",     7,  _lddea),
        Instruction(0x13, "inc de",         6,  _incss),
        Instruction(0x14, "inc d",          4,  _incr),
        Instruction(0x15, "dec d",          4,  _decr),
        Instruction(0x16, "ld d, %02x",     2,  _ldrn),
        Instruction(0x17, "rla",            4,  _rla),
        Instruction(0x18, "jr %02x",        12, _jre),
        Instruction(0x19, "add hl, de",     11, _addhlss),
        Instruction(0x1a, "ld a, (de)",     7,  _ldade),
        Instruction(0x1b, "dec de",         6,  _decss),
        Instruction(0x1c, "inc e",          4,  _incr),
        Instruction(0x1d, "dec e",          4,  _decr),
        Instruction(0x1e, "ld e, %02x",     2,  _ldrn),
        Instruction(0x1f, "rra",            4,  _rra),
    ],
    // row 2
    [
        Instruction(0x20, "jr nz, %02x",    7,  _jrnze),
        Instruction(0x21, "ld hl, %04x",    10, _ldddnn),
        Instruction(0x22, "ld (%04x), hl",  16, _ldnnhl),
        Instruction(0x23, "inc hl",         6,  _incss),
        Instruction(0x24, "inc h",          4,  _incr),
        Instruction(0x25, "dec h",          4,  _decr),
        Instruction(0x26, "ld h, %02x",     2,  _ldrn),
        Instruction(0x27, "daa",            4,  _daa),
        Instruction(0x28, "jr z, %02x",     7,  _jrze),
        Instruction(0x29, "add hl, hl",     11, _addhlss),
        Instruction(0x2a, "ld hl, (%04x)",  16, _ldhlnn),
        Instruction(0x2b, "dec hl",         6,  _decss),
        Instruction(0x2c, "inc l",          4,  _incr),
        Instruction(0x2d, "dec l",          4,  _decr),
        Instruction(0x2e, "ld l, %02x",     2,  _ldrn),
        Instruction(0x2f, "cpl",            4,  _cpl),
    ],
    // row 3
    [
        Instruction(0x30, "jr nc, %02x",    7,  _jrnce),
        Instruction(0x31, "ld sp, %04x",    10, _ldddnn),
        Instruction(0x32, "ld (%04x), a",   13, _ldnna),
        Instruction(0x33, "inc sp",         6,  _incss),
        Instruction(0x34, "inc (hl)",       11, _incr),
        Instruction(0x35, "dec (hl)",       4,  _decr),
        Instruction(0x36, "ld (hl), %02x",  10, _ldrn),
        Instruction(0x37, "scf",            4,  _scf),
        Instruction(0x38, "jr c, %02x",     7,  _jrce),
        Instruction(0x39, "add hl, sp",     11, _addhlss),
        Instruction(0x3a, "ld a, (%04x)",   13, _ldann),
        Instruction(0x3b, "dec sp",         6,  _decss),
        Instruction(0x3c, "inc a",          4,  _incr),
        Instruction(0x3d, "dec a",          4,  _decr),
        Instruction(0x3e, "ld a, %02x",     2,  _ldrn),
        Instruction(0x3f, "ccf",            4,  _ccf),
    ],
    // row 4
    [
        Instruction(0x40),
