...
final class LD_dd_nn : Strategy {
    ...
    override void execute(Z80 cpu, Op op) const {
        ...
        switch(bits) {
            ...
            case 2: s.setReg16(op.regHL, value); break;
...
final class LD_nn_REG : Strategy {
    ...
    override void execute(Z80 cpu, Op op) const {
        ...
        if(is8Bit(reg)) {
            ...
            // HL, IX, IY
            auto r = reg==Reg.HL ? op.regHL : reg;
...
final class INCss : Strategy {
    ...
    override void execute(Z80 cpu, Op op) const {
        ...
        switch(bits) {
            ...
            case 1: s.DE++; break;
            case 2:
                ushort old = s.getReg16(op.regHL);
                s.setReg16(op.regHL, (old+1).as!ushort);
                break;
            case 3: s.SP++; break;
            default: break;
        }
...
final class EX_SP_HL : Strategy {
    ...
    override void execute(Z80 cpu, Op op) const {
        ...
        ushort temp = s.getReg16(op.regHL);
        s.setReg16(op.regHL, cpu.readWord(s.SP));
...
final class PUSHqq : Strategy {
    ...
    override void execute(Z80 cpu, Op op) const {
        ...
        switch(qq) {
            ...
            case 2: value = s.getReg16(op.regHL); break;
